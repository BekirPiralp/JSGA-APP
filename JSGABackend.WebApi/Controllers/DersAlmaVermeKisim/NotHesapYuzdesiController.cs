...
namespace JSGABackend.WebApi.Controllers.DersAlmaVermeKisim
{
    [ApiController]
    public class NotHesapYuzdesiController : BaseController<NotHesapYuzdesi, INotHesapYuzdesiBusiness>
    {
    }
}

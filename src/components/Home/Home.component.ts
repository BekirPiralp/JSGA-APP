...
export class HomeComponent implements OnInit {
  ...
  public click():void {
    ...
    this.background_img1_UrlString = "../../assets/giris4.jpg";
  } 
    ...
    if(str !== undefined){
      switch(str){
        case 'Hakkinda':
            ...
            $("about").show();
            this.background_img1_UrlString = "https://cdn1.ntv.com.tr/gorsel/2Uu5W3bc_kCxBtqljM_auQ.jpg?width=1080&mode=crop&scale=both";
        break;
        case 'Anasayfa':

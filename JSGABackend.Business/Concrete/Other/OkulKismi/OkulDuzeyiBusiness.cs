...
namespace JSGABackend.Business.Concrete.Other.OkulKismi
{
    public class OkulDuzeyiBusiness : BaseForBusiness<IOkulDuzeyiDataAccess, OkulDuzeyi>, IOkulDuzeyiBusiness
    {

...
namespace JSGABackend.Business.Concrete.Other.DersAlmaVermeKismi
{
    public class OgrenciDersAlmaBusiness : BaseForBusiness<IOgrenciDersAlmaDataAccess, OgrenciDersAlma>, IOgrenciDersAlmaBusiness
    {

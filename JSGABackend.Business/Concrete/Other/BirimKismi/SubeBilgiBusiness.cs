...
namespace JSGABackend.Business.Concrete.Other.BirimKismi
{
    public class SubeBilgiBusiness : BaseForBusiness<ISubeBilgiDataAccess, SubeBilgi>, ISubeBilgiBusiness
    {

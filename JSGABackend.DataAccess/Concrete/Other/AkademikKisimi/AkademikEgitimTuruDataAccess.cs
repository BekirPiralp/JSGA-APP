...
{
	public class AkademikEgitimTuruDataAccess :
		EntityBaseForEntityFrameworkDataAccess<AkademikEgitimTuru, EntityFrameworkContextMsSql>,
		IAkademikEgitimTuruDataAccess
	{
	}
}

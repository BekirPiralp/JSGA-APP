...
{
	public class SahisKullaniciAdiDataAccess :
		EntityBaseForEntityFrameworkDataAccess<SahisKullaniciAdi,EntityFrameworkContextMsSql>,
		ISahisKullaniciAdiDataAccess
	{
	}
}
